{{-- ════════════════════════════════════════════════════════
     ...
     Props:
       ...
       $href         — string   e.g. url for detail/edit
 ════════════════════════════════════════════════════════ --}}
...
<li class="group bg-slate-50/50 border border-slate-100 rounded-xl hover:bg-white hover:border-blue-100 hover:shadow-sm transition-all duration-300 cursor-pointer overflow-hidden">
    <a href="{{ $href }}" class="flex flex-col sm:flex-row sm:items-center gap-3 p-4 w-full h-full">
