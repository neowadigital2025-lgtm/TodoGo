...
<a href="{{ $href }}" class="relative p-4 rounded-xl {{ $color }} border border-transparent hover:border-blue-200 transition-all duration-300 cursor-pointer group hover:shadow-md hover:shadow-blue-500/5 hover:-translate-y-0.5 block">
