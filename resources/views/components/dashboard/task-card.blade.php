...
<a href="#" class="group relative block bg-white rounded-xl border border-slate-200 hover:border-blue-400 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 hover:-translate-y-1">
